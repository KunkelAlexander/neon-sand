...
/** @type {string} */
const CACHE_VERSION = '1744549143|8296862482';
/** @type {string} */
const CACHE_PREFIX = 'NeonSand-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libsandsimulation.web.template_release.wasm32.nothreads.wasm"];
